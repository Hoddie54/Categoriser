...
categories = ('Place value, Order and compare numbers',
'Negative numbers',
'Number sequences',
...
'Time including Analogue and digital clocks (12hr/24hr), Estimating times, Calenders, months, dates and problems',
'Perimeter, Area',
'Area of parallelograms and triangles, Solve problems on area and perimeter',
'Volume and Solve volume problems',
...
'Bar Charts, Bar graphs, tally chart, pictograms and tables, time graphs, and interpreting'
'Venn, Carroll diagrams, Pie charts, line graphs and solving related problems',
'Mean, Median and Mode, and solving related problems',
)
